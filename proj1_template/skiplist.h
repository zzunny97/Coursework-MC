...
public:
    ...
    {
        cout << "====insert func start==== KEY: " << searchKey << endl;
        skiplist_node<K,V,MAXLEVEL>* update[MAXLEVEL];
        NodeType* currNode = m_pHeader;
        cout << "max_curr_level: " << max_curr_level << endl;
        cout << m_pHeader << " " << m_pTail << endl;

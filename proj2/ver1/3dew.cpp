...
int main(int argc, char **argv)
{
	...
	for(ishot=1;ishot<=(int)nshot;ishot++)
	{
		...
		for(l=1;l<=lt;l++)
		{
			...
			#pragma omp parallel
			{
				#pragma omp for private(tempux2, tempuy2, tempuz2, tempvx2, tempvy2, tempvz2, tempwx2, tempwy2, tempwz2, px , vvp2, vvs2, tempuxz, tempuxy, tempvyz, tempvxy, tempwxz, tempwyz) 
